...
class CreateCotizacionAbrasivosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('cotizacion_abrasivos', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('cotizacion_abrasivos');
    }
}
