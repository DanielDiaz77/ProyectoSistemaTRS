    ...
    <body>
        ...
        <header>
            ...
            <div>
                ...
                <p style="float: right;"> <strong >Ingreso</strong>  : {{$in->num_comprobante}}</p>
            </div>
