...
<html>
    ...
    <title>Cotizacion de PresupuestosES</title>
    <style>
    ...
    <body>
            ...
            <div>
                <table id="facliente" align="right">
                    ...
                    <tbody>
                        ...
                        <tr>
                            <th>
                                <span style="font-size: 15px ; color: #f3861c" align="left">Valor del Proyecto:</span> <span style="font-size: 15px" align="left"> ${{number_format($c->neto,2)}} </span><br>
                                <strong style="font-size: 15px ; color: #f3861c" align="left">Descripcion del Proyecto:</strong> <br><span align="left">{{$c->content}}</span> <br>
                            </th>
                        </tr>
        ...
        <section>
            <div>
                ...
                <strong>Direcion Instalacion: </strong> {{$c->observacion}}

                  @elseif ($c->instalacion == 0)
                  ...
                  <strong>Direcion del Flete: </strong> {{$c->observacion}}
