    ...
    <div class="container box" style="width: 970px;">
        <div class="row">
            ...
            <div class="col-12 mt-3">
                <h4 style="text-align:center;"> Factura presupuesto {{ $num_pre }}</h4>
                <p> <u>Presente:</u> </p>
                <p> {{ $data['name'] }} </p>
                <p>Buen dia, le hago llegar la factura de su presupuesto, esperando que todo este correcto. <br> estamos a sus ordenes.</p>
                <p> Contacto <u>recepcion@troystone.com.mx</u> </p>
            </div>
