    ...
    <div class="container-fluid p-1">
      ...
      <div class="card">
        <div class="card-header">
          <i class="fa fa-align-justify"></i> Cotizacion Javas
                            ...
                            <tbody v-if="arrayDetalle.length">
                                <tr v-for="(detalle,index) in arrayDetalle" :key="detalle.id">
                                   ...
                                   <td>
                                    ...
                                    <td>
                                       {{ (( (detalle.alto * detalle.largo * detalle.cantidad) * detalle.precio) - detalle.descuento) }}
                                    </td>
                                </tr>
                ...
                <div class="form-group row border">
                    <div class="col-sm-4">
                        <div class="form-group">
                            <label for=""><strong>Articulo</strong> <span style="color:red;" v-show="articulo==''">(*Seleccione)</span> </label>
                            <div class="form-inline">
                                <input type="text" class="form-control" v-model="codigo" @keyup.enter="buscarArticulo()"  placeholder="Ingrese el no° de java" >
                                <button @click="abrirModal()" class="btn btn-primary">...</button>
                                <input type="text" readonly class="form-control" v-model="articulo">
                            </div>
                        </div>
...
export default {
    ...
    methods: {
        listarCotizacion (page,buscar,criterio,estadoCotizacion){
            let me=this;
            var url= '/cotizacionjava?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio + '&estado='+ estadoCotizacion;
        ...
        registrarCotizacion(){
            ...
            var numcomp = "CF-".concat(me.CodeDate,"-",me.num_comprobante);

            axios.post('/cotizacionjava/registrar',{
        ...
        desactivarCotizacion(id) {
            ...
            .then(result => {
                if (result.value) {
                    let me = this;
                    axios.put('/cotizacionjava/desactivar',{
                        'id': id
                    }).then(function (response) {
                        me.listarCotizacion(1,'','num_comprobante','');
                        swal.fire(
        ...
        verCotizacion(id){
            ...
            var url= '/cotizacionjava/obtenerCabecera?id=' + id;
            ...
            var url= '/cotizacionjava/obtenerDetalles?id=' + id;
            axios.get(url).then(function (response) {
                var respuesta= response.data;
            ...
            if(me.encuentra(data['id'])){
                ...
                if(data['comprometido'] ==1){
                    Swal.fire({
                        type: 'error',
                        title: 'Lo siento...',
                        text: 'Esta java esta comprometida!',
                    })
                }else{
                    me.arrayDetalle.push({
                        idarticulo       : data['id'],
        ...
        listarArticuloCotizado(page,buscar,criterio){
            let me=this;
            var url= '/java/listarArticuloCotizado?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
            axios.get(url).then(function (response) {
                var respuesta= response.data;
                me.arrayArticulo = respuesta.articulos.data;
        ...
        aceptarCotizacion(id){
          let me = this;
            ...
            axios.put('/cotizacionjava/aceptarCotizacion',{
                'id': id,
        ...
        pdfCotizacion(id){
            window.open('/cotizacionjava/pdf/'+id,'_blank');
        },
        getLastNum(){
            let me=this;
            var url= '/cotizacionjava/nextNum';
            axios.get(url).then(function (response) {
                var respuesta= response.data;
        ...
        actualizarObservacion(id){
            let me = this;
            axios.post('/cotizacionjava/actualizarObservacion',{
                'id': id,
                'observacion' : this.observacion
            }).then(function (response) {
                me.obsEditable = 0;
        ...
        desactivarCotizacionVenta(id) {
            ...
            let me = this;
            axios.put('/cotizacionjava/desactivarVenta',{
                'id': id
            }).then(function (response) {
                me.ocultarDetalle();
                me.listarCotizacion(1,'','num_comprobante','');
        ...
        sendMailCot(id,mail,cliente){
            let me = this;
            axios.post('/cotizacionjava/enviarCotizacionMail',{
                'id': id,
                'mail' : mail,
                'name' : cliente
            }).then(function (response) {
