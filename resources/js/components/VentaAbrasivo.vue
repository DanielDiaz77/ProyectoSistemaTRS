    ...
    <div class="container-fluid p-1">
      ...
      <div class="card">
        <div class="card-header">
          <i class="fa fa-align-justify"></i> Venta Abrasivos
                            ...
                            <tbody v-if="arrayDetalle.length">
                                <tr v-for="(detalle,index) in arrayDetalle" :key="detalle.id">
                                   ...
                                   <td>
                                    ...
                                    <td>
                                       {{ ((( (detalle.cantidad) * detalle.precio) - detalle.descuento)).toFixed(6) }}
                                    </td>
                                </tr>
                                ...
                                <tr style="background-color: #CEECF5;">
                                    <td colspan="9" align="right"><strong>Total IVA:</strong></td>
...
export default {
    ...
    computed:{
        ...
        calcularTotal : function(){
            ...
            for(var i=0;i<me.arrayDetalle.length;i++){
                subtotal += ((me.arrayDetalle[i].precio * me.arrayDetalle[i].cantidad)-me.arrayDetalle[i].descuento);
    ...
    methods: {
        listarVenta (page,buscar,criterio,estadoVenta,estadoEntrega,estadoPago){
            let me=this;
            var url= '/ventaabrasivo?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio +
        ...
        buscarArticulo(){
            let me = this;
            var url= '/abrasivo/buscarArticuloVenta?filtro='+ me.codigo;
        ...
        agregarDetalle(){
            let me = this;
            if(me.idabrasivo == 0 || me.precio == 0 || me.cantidad == 0){
            }else{
                if(me.encuentra(me.idabrasivo)){
                    Swal.fire({
                        type: 'error',
                        title: 'Error...',
                        text: 'Este Código ya esta en el listado!',
                    })
                    me.codigo = "";
                    me.sku = "";
                    me.idabrasivo = "";
                    ...
                    if(me.cantidad > me.stock){
                        Swal.fire({
                            type: 'error',
                            title: 'Error...',
                            text: 'La cantidad excede los articulos disponibles!',
                        });
                    }else{
                        me.arrayDetalle.push({
                            idabrasivo       : me.idabrasivo,
        ...
        registrarVenta(){
            ...
            let me = this;
            var numcomp = "VA-".concat(me.CodeDate,"-",me.num_comprobante);
            ...
            axios.post('/ventaabrasivo/registrar',{
            ...
            if ( adeudo > 0 ){
                ...
                .then(result => {
                    if (result.value) {
                        let me = this;
                        let genNc = false;
                        axios.put('/ventaabrasivo/desactivar',{
                            'id': id,
                            'genNc' : genNc
                        }).then(function (response) {
                            me.listarVenta(1,'','num_comprobante','','','');
        ...
        listarArticulo(page,buscar,criterio,bodega){
            ...
            var url= '/abrasivo/listarArticuloVenta?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio
            + '&bodega=' + bodega;
            axios.get(url).then(function (response) {
                var respuesta= response.data;
        ...
        cambiarEstadoEntrega(id){
            ...
            axios.post('/ventaabrasivo/cambiarEntrega',{
                'id': id,
        ...
        cambiarEstadoEntregaParcial(id){
            ...
            axios.post('/ventaabrasivo/cambiarEntregaParcial',{
                'id': id,
        ...
        cambiarEstadoPagado(id){
          let me = this;
            ...
            axios.post('/ventaabrasivo/cambiarPagado',{
                'id': id,
                'pagado' : this.pagado
            }).then(function (response) {
                me.verVenta(id);
        ...
        cambiarEstadoFactura(id){
            ...
            axios.post('/ventaabrasivo/cambiarFactura',{
                'id': id,
        ...
        actualizarObservacion(id){
            let me = this;
            axios.post('/ventaabrasivo/actualizarObservacion',{
                'id': id,
                'observacion' : this.observacion
            }).then(function (response) {
                me.obsEditable = 0;
        ...
        actualizarObservacionPriv(id){
            let me = this;
            axios.post('/ventaabrasivo/actualizarObservacionPriv',{
                'id': id,
                'observacionpriv' : this.observacionpriv
            }).then(function (response) {
        ...
        listarExcel(inicio, fin,selectedUsers){
            if (this.usrol != 1){
                ...
                window.open('/ventaabrasivo/ExportExcel?inicio=' + inicio + '&fin=' + fin + '&usuarios=' + ArrUsuarios);
            }else{
        ...
        listarExcelDet(inicio, fin,selectedUsers){
            if (this.usrol != 1){
                var ArrUsuarios = [];
                ArrUsuarios.push(this.usid);
                window.open('/ventaabrasivo/ExportExcelDet?inicio=' + inicio + '&fin=' + fin + '&usuarios=' + ArrUsuarios);
            }else{
                if(!selectedUsers.length){
                    swal.fire(
                    'Atencion!',
        ...
        getDeposits(id){
            let me = this;
            var url= '/ventaabrasivo/getDeposits?id=' + id;
            axios.get(url).then(function (response){
                var respuesta= response.data;
        ...
        deleteDeposit(id,idventa,total){
            ...
            .then(result => {
                if (result.value) {
                    let me = this;
                    axios.put('/ventaabrasivo/eliminarDeposit',{
                        'id': id,
                        'idventa' : idventa,
                        'total' : total
                    }).then(function (response) {
        ...
        listarAbonosExcel(inicio, fin){
              window.open('/ventaabrasivo/AbonoExportExcel?inicio=' + inicio + '&fin=' + fin);
        },
        ...
        saveDeposit(id,adeudo,total){
            ...
            if(this.forma_pagoab == ''){
                ...
                if(abono > adeudo){
                    ...
                    let me = this;
                    axios.post('/ventaabrasivo/crearDeposit',{
                        'id' : id,
                        'total' : abono,
        ...
        autorizarEntrega(id,pr){
            ...
            axios.put('/ventaabrasivo/autorizarEntrega',{
                'id': id,
        ...
        guardarAbonoCredit(id,adeudo,total,nuevo_total){
            ...
            if(abono2 > abono > adeudo){
                ...
                axios.post('/ventaabrasivo/crearDepositCredit',{
                    'id'         : id,
                    'total'      : abono,
                    'forma_pago' : this.forma_pagoab,
        ...
        sendMailPresupuesto(id,mail,cliente){
            let me = this;
            axios.post('/ventaabrasivo/enviarPresupuestoMail',{
                'id': id,
                'mail' : mail,
                'name' : cliente
            }).then(function (response) {
        ...
        cambiarEstadoSpecial(id){
            ...
            axios.post('/ventaabrasivo/cambiarSpecial',{
                'id': id,
                'especial' : is_special
            }).then(function (response) {
                me.verVenta(id);
