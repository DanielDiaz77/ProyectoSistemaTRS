      ...
      <!-- Ejemplo de tabla Listado -->
        <div class="card">
            <div class="card-header p-2">
                  <i class="fa fa-align-justify"></i> Artículos con Edicion
                        ...
                        <div class="row">
                            <div class="input-group input-group-sm col-12 col-lg-3 mb-3">
                                ...
                                <select class="form-control" v-model="idcategoria">
                                    ...
                                    <option v-for="categoria in arrayCategoria" :key="categoria.id" :value="categoria.id" v-text="categoria.nombre" disabled></option>
                                </select>
                            </div>
                            <div class="input-group input-group-sm col-12 col-lg-3  mb-3">
                                <div class="input-group-append">
                                ...
                                <input type="text" v-model="sku" class="form-control" placeholder="Código de material" disabled/>
                            </div>
                            <div class="input-group input-group-sm col-12 col-lg-3  mb-3">
                                <div class="input-group-append">
                                    <span class="input-group-text">No° de placa</span>
                                </div>
                                <input type="text" v-model="codigo" class="form-control" placeholder="Num de placa" disabled/>
                            </div>
                            <div class="input-group input-group-sm col-12 col-lg-3  mb-3">
                                <div class="input-group-append">
                                    <span class="input-group-text">Terminado</span>
...
export default {
    ...
    methods: {
        ...
        cambiarSalida(id) {
            ...
            swalWithBootstrapButtons.fire({
                title: "¿Esta seguro de marcar el articulo con Exhibida?",
                type: "warning",
                showCancelButton: true,
                confirmButtonText: "Aceptar!",
                cancelButtonText: "Cancelar!",
        ...
        updateCortado(){
            ...
            let me = this;
            axios.put("/articulo/actualizarCortes",{
                'id': this.articulo_id,
                'stock' : this.stock,
                'observacion': this.observacion,
