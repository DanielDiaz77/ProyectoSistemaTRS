        ...
        <!-- Ejemplo de tabla Listado -->
            <div class="card">
                <div class="card-header">
                        ...
                        <i class="fa fa-align-justify"></i> Traslado Abrasivos
                                        ...
                                        <table class="table table-bordered table-striped table-sm table-hover">
                                            ...
                                            <tbody v-if="arrayDetalle.length">
                                                <tr v-for="(detalle,index) in arrayDetalle" :key="detalle.id">
                                                    ...
                                                    <td v-text="detalle.stock - detalle.cantidad"></td>
                        ...
                        <div class="form-inline">
                            <div class="form-group col-12">
                                <div class="input-group input-group-sm col-12 col-lg-8 col-xl-8 mb-3 p-1">
                                    ...
                                    <input type="text" v-model="buscarArt" @keyup.enter="listarArticulo(1,buscarArt,criterioArt,bodegaArt)" class="form-control" placeholder="Texto a buscar">
                                </div>
                                <div class="input-group input-group-sm col-12 col-lg-6 col-xl-4 mb-3 p-1">
                                    <div class="input-group-append">
                                        <span class="input-group-text">Ubicación</span>
                                    </div>
                                    <select class="form-control" v-model="bodegaArt" @change="listarArticulo(1,buscarArt,criterioArt,bodegaArt)">
                                ...
                                <div class="input-group input-group-sm col-12 col-lg-6 col-xl-3 mb-3 p-1">
                                    ...
                                    <select class="form-control" v-model="zona" @change="listarArticulo(1,buscarArt,criterioArt,bodegaArt)">
                                        <option value="GDL">Guadalajara</option>
                                        <option value="SLP">San Luis</option>
                                         <option value="AGS">Aguascalientes</option>
                                    </select>
                                </div>
                                 <button type="submit" @click="listarArticulo(1,buscarArt,criterioArt,bodegaArt)" class="btn btn-sm btn-primary col-1 mb-3 p-1"><i class="fa fa-search"></i></button>
                            </div>
                        </div>
                        <div class="table-responsive">
                        ...
                        <nav>
                            <ul class="pagination">
                                <li class="page-item" v-if="paginationart.current_page > 1">
                                    <a class="page-link" href="#" @click.prevent="cambiarPaginaArt(paginationart.current_page - 1,buscarArt,criterioArt,bodegaArt)">Ant</a>
                                </li>
                                <li class="page-item" v-for="page in pagesNumberArt" :key="page" :class="[page == isActivedArt ? 'active' : '']">
                                    <a class="page-link" href="#" @click.prevent="cambiarPaginaArt(page,buscarArt,criterioArt,bodegaArt)" v-text="page"></a>
                                </li>
                                <li class="page-item" v-if="paginationart.current_page < paginationart.last_page">
                                    <a class="page-link" href="#" @click.prevent="cambiarPaginaArt(paginationart.current_page + 1,buscarArt,criterioArt,bodegaArt)">Sig</a>
                                </li>
                            </ul>
                        </nav>
...
Vue.use(ToggleButton)
    export default {
        ...
        computed:{
            ...
            calcularStockA: function(){
                let me = this;
                let resultado = 0;
                resultado = resultado +(me.stock - me.cantidad);
                me.stock = resultado;
                return resultado;
            },
            calcularStockB: function(){
                let me = this;
                let resultado = 0;
                for(var i=0;i<me.arrayDetalle.length;i++){
                    resultado += ((me.arrayDetalle[i].stock) + me.arrayDetalle[i].cantidad)
        ...
        methods: {
            listarTraslado(page,buscar,criterio,estadoTraslado){
                let me=this;
                me.btnNewTask = 1;
                var url= '/trasladoabrasivo?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio + '&estado='+ estadoTraslado;
                axios.get(url,{
                    params:{
            ...
            abrirModal() {
                ...
                this.listarArticulo(1,this.buscarArt,this.criterioArt,this.bodegaArt);
            },
            editArticulo(data = []){
            ...
            actualizarTraslado(){
                ...
                axios.post('/trasladoabrasivo/actualizar',{
                    'id'              : this.traslado_id,
                    'tipo_comprobante': this.tipo_comprobante,
