                    ...
                    <form action method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="row">
                            ...
                            <div class="input-group input-group-sm col-12 col-lg-3  mb-3">
                                ...
                                <input type="text" v-model="codigo" class="form-control" placeholder="Num de java" disabled/>
                            </div>
                            <div class="input-group input-group-sm col-12 col-lg-3  mb-3">
                                <div class="input-group-append">
                                    <span class="input-group-text">Terminado</span>
...
export default {
    ...
    methods: {
        listarArticulo (page,buscar,criterio,bodega,acabado,estado,idcategoria){
            ...
            var url= '/java?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio + '&bodega='
        ...
        this.$copyText(formatArticulo).then(function (e) {
            ...
            Swal.fire({
                position: 'top-end',
                type: "danger",
                text: 'No se pudo copiar la información de la Java',
                showConfirmButton: false,
                timer: 1000
            });
        })
