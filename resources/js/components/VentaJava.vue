    ...
    <div class="container-fluid p-1">
      ...
      <div class="card">
        <div class="card-header">
          <i class="fa fa-align-justify"></i> Venta Javas
                        ...
                        <table class="table table-bordered table-striped table-sm table-hover">
                            ...
                            <tbody v-if="arrayDetalle.length">
                                <tr v-for="(detalle,index) in arrayDetalle" :key="detalle.id">
                                    ...
                                    <td v-text="detalle.largo * detalle.alto * detalle.cantidad"></td>
                                    <td>
                                   ...
                                   <td>
                                    ...
                                    <td>
                                       {{ ((( (detalle.alto * detalle.largo * detalle.cantidad) * detalle.precio) - detalle.descuento)).toFixed(6) }}
                                    </td>
                                </tr>
...
export default {
    ...
    computed:{
        ...
        calcularTotal : function(){
            ...
            for(var i=0;i<me.arrayDetalle.length;i++){
                subtotal += (((me.arrayDetalle[i].precio * me.arrayDetalle[i].alto * me.arrayDetalle[i].largo)
                * me.arrayDetalle[i].cantidad)-me.arrayDetalle[i].descuento);
        ...
        metrosTotales : function(){
            ...
            let resultado = 0;
            for(var i=0;i<me.arrayDetalle.length;i++){
                resultado += parseFloat(me.arrayDetalle[i].largo * me.arrayDetalle[i].alto * me.arrayDetalle[i].cantidad);
            }
            return resultado;
        },
    ...
    methods: {
        listarVenta (page,buscar,criterio,estadoVenta,estadoEntrega,estadoPago){
            let me=this;
            var url= '/ventajava?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio +
        ...
        buscarArticulo(){
            let me = this;
            var url= '/java/buscarArticuloVenta?filtro='+ me.codigo;
            ...
            if(me.idarticulo == 0 || me.precio == 0 || me.cantidad == 0){
                ...
                if(me.encuentra(me.idarticulo)){
                    Swal.fire({
                        type: 'error',
                        title: 'Error...',
                        text: 'Este No° de java ya esta en el listado!',
                    })
                    me.codigo = "";
                    me.sku = "";
                    me.idarticulo = "";
                    ...
                    if(me.cantidad > me.stock){
                        Swal.fire({
                            type: 'error',
                            title: 'Error...',
                            text: 'La cantidad excede las javas disponibles de este material!',
                        });
                    }else{
        ...
        registrarVenta(){
            ...
            let me = this;
            var numcomp = "VJ-".concat(me.CodeDate,"-",me.num_comprobante);
            ...
            axios.post('/ventajava/registrar',{
            ...
            if ( adeudo > 0 ){
                ...
                .then(result => {
                    if (result.value) {
                        let me = this;
                        let genNc = false;
                        axios.put('/ventajava/desactivar',{
                            'id': id,
                            'genNc' : genNc
                        }).then(function (response) {
                            me.listarVenta(1,'','num_comprobante','','','');
        ...
        verVenta(id){
            ...
            var arrayVentaT=[];
            var url= '/ventajava/obtenerCabecera?id=' + id;
            ...
            var url= '/ventajava/obtenerDetalles?id=' + id;
            axios.get(url).then(function (response) {
                var respuesta= response.data;
        ...
        updateCorte(){
            ...
            let me = this;
            axios.put("/ventajava/actualizarCorte",{
                'id' : this.articulo_id,
                'stock':this.stock,
        ...
        cambiarEstadoEntrega(id){
            ...
            axios.post('/ventajava/cambiarEntrega',{
                'id': id,
        ...
        cambiarEstadoEntregaParcial(id){
            ...
            axios.post('/ventajava/cambiarEntregaParcial',{
                'id': id,
        ...
        cambiarEstadoPagado(id){
          let me = this;
            ...
            axios.post('/ventajava/cambiarPagado',{
                'id': id,
                'pagado' : this.pagado
            }).then(function (response) {
                me.verVenta(id);
        ...
        cambiarEstadoFactura(id){
            ...
            axios.post('/ventajava/cambiarFactura',{
                'id': id,
        ...
        actualizarObservacion(id){
            let me = this;
            axios.post('/ventajava/actualizarObservacion',{
                'id': id,
                'observacion' : this.observacion
            }).then(function (response) {
                me.obsEditable = 0;
        ...
        actualizarObservacionPriv(id){
            let me = this;
            axios.post('/ventajava/actualizarObservacionPriv',{
                'id': id,
                'observacionpriv' : this.observacionpriv
            }).then(function (response) {
        ...
        pdfVenta(id){
            window.open('/ventajava/pdf/'+id);
        },
        getLastNum(){
            let me=this;
            var url= '/ventajava/nextNum';
            axios.get(url).then(function (response) {
                var respuesta= response.data;
        ...
        listarExcel(inicio, fin,selectedUsers){
            if (this.usrol != 1){
                ...
                window.open('/ventajava/ExportExcel?inicio=' + inicio + '&fin=' + fin + '&usuarios=' + ArrUsuarios);
            }else{
        ...
        listarExcelDet(inicio, fin,selectedUsers){
            if (this.usrol != 1){
                var ArrUsuarios = [];
                ArrUsuarios.push(this.usid);
                window.open('/ventajava/ExportExcelDet?inicio=' + inicio + '&fin=' + fin + '&usuarios=' + ArrUsuarios);
            }else{
                if(!selectedUsers.length){
                    swal.fire(
                    'Atencion!',
        ...
        getDeposits(id){
            let me = this;
            var url= '/ventajava/getDeposits?id=' + id;
            axios.get(url).then(function (response){
                var respuesta= response.data;
        ...
        deleteDeposit(id,idventa,total){
            ...
            .then(result => {
                if (result.value) {
                    let me = this;
                    axios.put('/ventajava/eliminarDeposit',{
                        'id': id,
                        'idventa' : idventa,
                        'total' : total
                    }).then(function (response) {
        ...
        listarAbonosExcel(inicio, fin){
              window.open('/ventajava/AbonoExportExcel?inicio=' + inicio + '&fin=' + fin);
        },
        ...
        saveDeposit(id,adeudo,total){
            ...
            if(this.forma_pagoab == ''){
                ...
                if(abono > adeudo){
                    ...
                    let me = this;
                    axios.post('/ventajava/crearDeposit',{
                        'id' : id,
                        'total' : abono,
        ...
        autorizarEntrega(id,pr){
            ...
            axios.put('/ventajava/autorizarEntrega',{
                'id': id,
        ...
        guardarAbonoCredit(id,adeudo,total,nuevo_total){
            ...
            if(abono2 > abono > adeudo){
                ...
                axios.post('/ventajava/crearDepositCredit',{
                    'id'         : id,
                    'total'      : abono,
                    'forma_pago' : this.forma_pagoab,
        ...
        sendMailPresupuesto(id,mail,cliente){
            let me = this;
            axios.post('/ventajava/enviarPresupuestoMail',{
                'id': id,
                'mail' : mail,
                'name' : cliente
            }).then(function (response) {
        ...
        cambiarEstadoSpecial(id){
            ...
            axios.post('/ventajava/cambiarSpecial',{
                'id': id,
                'especial' : is_special
            }).then(function (response) {
                me.verVenta(id);
