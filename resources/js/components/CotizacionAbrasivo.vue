    ...
    <div class="container-fluid p-1">
      ...
      <div class="card">
        <div class="card-header">
          <i class="fa fa-align-justify"></i> Cotizacion Abrasivos
                ...
                <div class="form-group row border">
                    ...
                    <div class="col-sm-2 text-center">
                        <div class="form-group" v-if="moneda!='Peso Mexicano'">
                            <label for=""><strong>Precio  {{moneda}} </strong><span style="color:red;" v-show="precio==0">(*Ingrese)</span></label>
        ...
        <template v-else-if="listado==3">
            <div class="card-body">
                ...
                <div class="form-group row border">
                    ...
                    <div class="col-sm-2 text-center">
                        <div class="form-group">
                            <label for=""><strong>Precio</strong> <span style="color:red;" v-show="precio==0">(*Ingrese el precio)</span></label>
                            <input type="number" min="0" value="0" step="any" class="form-control" v-model="precio">
                        </div>
                    </div>
                    <div class="col-sm-2 text-center">
...
export default {
    ...
    methods: {
        listarCotizacion (page,buscar,criterio,estadoCotizacion){
            let me=this;
            var url= '/cotizacionabrasivo?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio + '&estado='+ estadoCotizacion;
                ...
                if(me.encuentra(me.idarticulo)){
                    ...
                    if(me.cantidad > me.stock){
                        Swal.fire({
                            type: 'error',
                            title: 'Error...',
                            text: 'La cantidad excede los abrasivos en stock!',
                        });
                    }else{
        ...
        registrarCotizacion(){
            ...
            var numcomp = "CA-".concat(me.CodeDate,"-",me.num_comprobante);

            axios.post('/cotizacionabrasivo/registrar',{
        ...
        desactivarCotizacion(id) {
            ...
            .then(result => {
                if (result.value) {
                    let me = this;
                    axios.put('/cotizacionabrasivo/desactivar',{
                        'id': id
                    }).then(function (response) {
                        me.listarCotizacion(1,'','num_comprobante','');
                        swal.fire(
        ...
        verCotizacion(id){
            ...
            var url= '/cotizacionabrasivo/obtenerCabecera?id=' + id;
            ...
            var url= '/cotizacionabrasivo/obtenerDetalles?id=' + id;
            axios.get(url).then(function (response) {
                var respuesta= response.data;
        ...
        listarArticuloCotizado(page,buscar,criterio){
            let me=this;
            var url= '/abrasivo/listarArticuloCotizado?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio;
            axios.get(url).then(function (response) {
                var respuesta= response.data;
                me.arrayArticulo = respuesta.articulos.data;
        ...
        actualizarArticulo() {
            ...
            let me = this;
            axios.put("/abrasivo/actualizarCorte", {
                'stock': this.stock,
                'id': this.idarticulo
            })
            .then(function(response) {
        ...
        aceptarCotizacion(id){
          let me = this;
            ...
            axios.put('/cotizacionabrasivo/aceptarCotizacion',{
                'id': id,
        ...
        pdfCotizacion(id){
            window.open('/cotizacionabrasivo/pdf/'+id,'_blank');
        },
        getLastNum(){
            let me=this;
            var url= '/cotizacionabrasivo/nextNum';
            axios.get(url).then(function (response) {
                var respuesta= response.data;
        ...
        actualizarObservacion(id){
            let me = this;
            axios.post('/cotizacionabrasivo/actualizarObservacion',{
                'id': id,
                'observacion' : this.observacion
            }).then(function (response) {
                me.obsEditable = 0;
        ...
        desactivarCotizacionVenta(id) {
            ...
            let me = this;
            axios.put('/cotizacionabrasivo/desactivarVenta',{
                'id': id
            }).then(function (response) {
                me.ocultarDetalle();
                me.listarCotizacion(1,'','num_comprobante','');
        ...
        sendMailCot(id,mail,cliente){
            let me = this;
            axios.post('/cotizacionabrasivo/enviarCotizacionMail',{
                'id': id,
                'mail' : mail,
                'name' : cliente
            }).then(function (response) {
