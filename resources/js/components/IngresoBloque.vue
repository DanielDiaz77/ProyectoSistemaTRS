    ...
    <div class="container-fluid">
      ...
      <div class="card">
        <div class="card-header">
          <i class="fa fa-align-justify"></i> Ingreso Bloques
            ...
            <div class="card-body">
                ...
                <div class="form-group row border">
                    ...
                    <div class="col-sm-2">
                     ...
                     <div class="col-sm-2">
                        <div class="form-group">
                            <label for=""><strong>Fecha de Pago</strong> <span style="color:red;" v-show="fecha_llegada==''">(*Seleccione)</span></label>
                ...
                <div class="form-group row border">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            <label for=""><strong>No° Bloque</strong> <span style="color:red;" v-show="codigo==0">(*Ingrese el no° de placa)</span></label>
                            <input type="text" class="form-control" v-model="codigo" placeholder="No° de bloque">
                        </div>
                    </div>
                    <div class="col-sm-2">
                        <div class="form-group">
                    ...
                    <div class="col-sm-1">
                        <div class="form-group">
                            <label for=""><strong>Ancho</strong> <span style="color:red;" v-show="ancho==0">(*Ingrese)</span></label>
                            <input type="number" value="2" min="0" class="form-control" v-model="ancho">
                        </div>
                    </div>
                    <div class="col-sm-1">
                        <div class="form-group">
                    ...
                    <div class="col-sm-2">
                        <div class="form-group">
                            <label for=""><strong>Metros<sup>3</sup></strong></label>
                    ...
                    <div class="col-sm-1">
                        <div class="form-group">
                            <label for=""><strong>Preciom<sup>3</sup> </strong><span style="color:red;" v-show="precio_venta==0">(*Ingrese)</span></label>
                    ...
                    <div class="col-sm-1 text-center mt-4 ">
                        <p class="mt-2 mb-1" style="font-size: 15px;"> Bloques añadidas  <strong> {{ arrayDetalle.length }} </strong>  </p>
                    </div>
                        ...
                        <table class="table table-bordered table-striped table-sm table-hover">
                            ...
                            <tbody v-if="arrayDetalle.length">
                                <tr v-for="(detalle,index) in arrayDetalle" :key="detalle.id">
                                    ...
                                    <td v-text="detalle.ancho"></td>
                                    <td v-text="detalle.largo"></td>
                                    <td v-text="detalle.alto"></td>
                                    <td v-text="detalle.metros_cubicos"></td>
                ...
                <div class="modal-body">
                    ...
                    <table class="table table-bordered table-striped table-sm text-center table-hover">
                        ...
                        <tr >
                            ...
                            <td>
                                <input type="text" class="form-control" v-model="ancho">
                            </td>
                        </tr>
                        <tr >
...
export default {
    ...
    computed:{
            ...
            calcularMts : function(){
                let me=this;
                let resultado = 0;
                resultado = resultado + (me.alto * me.largo * me.ancho);
    ...
    methods: {
        listarIngreso (page,buscar,criterio,estado){
            let me=this;
            var url= '/ingresobloque?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio + '&estado=' + estado;
        ...
        buscarArticulo(){
            let me = this;
            var url= '/bloque/buscarArticulo?filtro='+ me.codigo;
            axios.get(url).then(function (response) {
                let respuesta = response.data;
            ...
            if(me.codigo == 0 || me.idcategoria_r == 0 || me.alto == 0 || me.largo == 0){
                ...
                if(me.encuentraCodigoSku(me.codigo)){
                    Swal.fire({
                        type: 'error',
                        title: 'Error...',
                        text: 'Este No° de bloque ya esta en el sistema!',
                    });
                    me.codigo = "";
                }
                    ...
                    Swal.fire({
                        type: 'error',
                        title: 'Error...',
                        text: 'Este No° de bloque ya esta en el listado del detalle!',
                    });
                    me.codigo = "";
                }else{
                    me.arrayDetalle.push({
                        ...
                        largo            : me.largo,
                        alto             : me.alto,
                        metros_cubicos   : me.metros_cubicos,
        ...
        registrarArticulos() {
            ...
            if (this.active == true)
                active = 1;
            axios.post("/bloque/registrarDetalle", {
        ...
        registrarIngreso(){
            let me = this;
            var numcomp = "IB-".concat(me.CodeDate,"-",me.num_comprobante);
            let active = 0;
            if (this.active == true)
                active = 1;
            axios.post('/ingresobloque/registrar',{
        ...
        desactivarIngreso(id) {
            ...
            .then(result => {
                if (result.value) {
                    let me = this;
                    axios.put('/ingresobloque/desactivar',{
                        'id': id
                    }).then(function (response) {
        ...
        validarIngreso() {
            ...
            if (this.arrayDetalle.length<=0) this.errorMostrarMsjIngreso.push("Introduzca articulos para registrar");
        ...
        verIngreso(id){
            ...
            var arrayIngresoT=[];
            var url= '/ingresobloque/obtenerCabecera?id=' + id;
            axios.get(url).then(function (response) {
                var respuesta= response.data;
            ...
            var url= '/ingresobloque/obtenerDetalles?id=' + id;
            axios.get(url).then(function (response) {
                var respuesta= response.data;
        ...
        listarArticulo (page,buscar,criterio,bodega,acabado){
            let me=this;
            var url= '/bloque/listarArticulo?page=' + page + '&buscar='+ buscar + '&criterio='+ criterio + '&bodega=' + bodega + '&acabado=' + acabado;
            axios.get(url).then(function (response) {
                var respuesta= response.data;
        ...
        abrirModal2(index){
            ...
            me.ancho            = me.arrayDetalle[index]['ancho'];
            me.precio_venta     = me.arrayDetalle[index]['precio_venta'];
            me.metros_cubicos   = me.arrayDetalle[index]['metros_cubicos'];
        ...
        pdfIngreso(id){
            window.open('/ingresobloque/pdf/'+id);
        },
        cambiarEstadoIngreso(id, detalles) {
            ...
            if (this.btnActive) {
                let me = this;
                axios.post('/ingresobloque/cambiarEstadoIngreso',{
                'id': id,
                }).then(function(response) {
        ...
        cambiarEstadoArticulos(data) {
            let me = this;
            console.log(data);
            axios.post('/bloque/cambiarEstadoIngreso',{
                'data': data,
            }).then(function(response) {
                me.ocultarDetalle();
                Swal.fire({
